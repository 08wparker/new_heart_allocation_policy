---
title: Analysis for *Practice Changes at U.S. Transplant Centers After the New Adult Heart Allocation Policy*
...
```
Summary statistics for candidate characteristics of both the pre and post-policy cohort. At a p-value threshold of 0.05. We wanted to emphasize that this table lists the mean. The table in the article uses median and was produced in Stata.
